        ...
        <div className="row justify-content-center mt-4 mb-4 col-10 mx-auto">
          {categories.length > 0 ? (
            categories.map((category, index) => (
              ...
              >
                <div
                  className={`text-center card p-3 col-12 card-style ${
                    category.is_available ? "categories" : "blocked"
                  }`}
                >
                  <img
                    src={category.image}
                    ...
                    className={`card-img-top ${
                      !category.is_available && "grayscale"
                    }`}
                    style={{
                      objectFit: "cover",
                      width: "100%",
                  ...
                  <p
                    className={`text-center ${
                      !category.is_available ? "text-disabled" : ""
                    }`}
                  >
